    ...
    MobileArea.prototype = {
        ...
        bindEvent: function() {
            ...
            function areaCtrlInit() {
                try{_self.gearArea.querySelector(".area_province").setAttribute("val", _self.value[0])}
                catch(err){};
                try{_self.gearArea.querySelector(".area_city").setAttribute("val", _self.value[1])}
                catch(err){};
                try{_self.gearArea.querySelector(".area_county").setAttribute("val", _self.value[2])}
                catch(err){};
        ...
        finish: function(e) {
            ...
            var area_city = _self.gearArea.querySelector(".area_city");
            var area_county = _self.gearArea.querySelector(".area_county");
            var provinceVal='',provinceText='' ,cityVal='', cityText='', countyVal='', countyText='';
            if(area_province){
