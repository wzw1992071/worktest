(function(factory) {
    ...
    IndexSidebar.prototype.initialize = function(options) {
        ...
        this.el = document.querySelector(".acronym");
        // this.elChar = el.querySelector('.current-char')
        this.elChar = document.querySelector(".letter-show-box");
    ...
    IndexSidebar.prototype.initEvents = function(options) {
        ...
        if ('ontouchstart' in document) {
            ...
            el.addEventListener('touchmove', function handler(e) {
                if (touching) {
                    e.preventDefault()
                    var t = e.touches[0]
        ...
        function start(clientX, clientY) {
            touching = true
            elChar.style.visibility = 'visible'
        ...
        function end() {
            touching = false
            elChar.style.visibility = 'hidden'
        }
